        ...
        <div className="w-full h-full">
            {
                ...
                <div className="w-full h-full">
                            ...
                            (order)=>{
                                return(
                                    <tr key={order.orderId} className="border-b-2 border-gray-300 text-center cursor-pointer hover:bg-gray-100">
                                        ...
                                        <td className="p-2"><button className="bg-blue-500 text-white p-2 cursor-pointer"
                                            onClick={()=>{setModelIsDisplaying(true) 
                                                        setDisplayingOrder(order)}}>Details</button></td>
                                    </tr>
                                );
                            }
                        )
                    ...
                    {
                        modelIsDisplaying &&
                        <div className="fixed bg-[#00000070] w-full h-full top-0 left-0 flex items-center justify-center">
                            <div className="w-[600px] max-w-[600px] h-[600px] max-h-[600px]  bg-white relative ">
                                ...
                                <button onClick={()=>{setModelIsDisplaying(false)}} className=" w-[40px] h-[40px] absolute right-[-20px] top-[-20px] rounded-full bg-white shadow shadow-black cursor-pointer flex justify-center items-center"><IoCloseSharp/></button>
                            </div> 
                        </div>
                    }
                </div>
